...
export default function GithubPulse() {
  ...
  const fetchGithubData = useCallback(async () => {
    ...
    try {
      ...
      // 2. Fetch contributions calendar (using a proxy or fallback if needed)
      // For GitHub profile stats, we fetch from a public GraphQL endpoint if possible or use a proxy.
      // Since GraphQL requires token, we use a public JSON endpoint or fallback on error
